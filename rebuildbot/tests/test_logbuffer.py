"""
rebuildbot/tests/test_logbuffer.py
...
from rebuildbot.logbuffer import LogBuffer


class TestLogBuffer(object):
    ...
    def test_write(self):
        b = LogBuffer()
        b.write("foo")
        assert b.content == 'foo'

    def test_write_multi(self):
        b = LogBuffer()
        b.write("foo")
        b.write("bar")
        assert b.content == 'foobar'
